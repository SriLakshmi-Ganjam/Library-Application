...
//								}
						...
						case 7:
							try {
								...
								System.out.println(String.format("%-15s %-15s %-15s %-15s %-25s %-15s","REQUEST ID", "USER ID",
										"BOOK ID", "ISSUED DATE", "EXPECTED RETURNED DATE",
										"RETURNED DATE"));

								for (RequestInfo info : requestInfos) {

									System.out.println(String.format("%-15s %-15s %-15s %-15s %-25s %-15s",info.getRequestId(),
											info.getUserId(), info.getBookId(), 
											info.getIssuedDate(), info.getExpectedReturnDate(),
